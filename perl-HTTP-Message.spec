...
Source0  : https://cpan.metacpan.org/authors/id/O/OA/OALDERS/HTTP-Message-6.31.tar.gz
...
%prep
%setup -q -n HTTP-Message-6.31
cd %{_builddir}/HTTP-Message-6.31
...
cp %{_builddir}/HTTP-Message-6.31/LICENSE %{buildroot}/usr/share/package-licenses/perl-HTTP-Message/eeeb3a21464437014b95494ac4a3b662a0541bbb
if test -f Makefile.PL; then
