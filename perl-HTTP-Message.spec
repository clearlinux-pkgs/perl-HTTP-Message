...
Source0  : https://cpan.metacpan.org/authors/id/O/OA/OALDERS/HTTP-Message-6.37.tar.gz
...
%prep
%setup -q -n HTTP-Message-6.37
cd %{_builddir}/HTTP-Message-6.37
...
cp %{_builddir}/HTTP-Message-6.37/LICENSE %{buildroot}/usr/share/package-licenses/perl-HTTP-Message/a1d07eb75180e7a1eb584ced7bca9fac428d2f00
if test -f Makefile.PL; then
