...
Source0  : https://cpan.metacpan.org/authors/id/O/OA/OALDERS/HTTP-Message-6.22.tar.gz
...
%prep
%setup -q -n HTTP-Message-6.22
cd %{_builddir}/HTTP-Message-6.22
...
cp %{_builddir}/HTTP-Message-6.22/LICENSE %{buildroot}/usr/share/package-licenses/perl-HTTP-Message/ce15abc341eabcc3c1f7d79a2c30a529aaa129a4
if test -f Makefile.PL; then
