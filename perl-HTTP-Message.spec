...
Version  : 6.28
Release  : 41
URL      : https://cpan.metacpan.org/authors/id/O/OA/OALDERS/HTTP-Message-6.28.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/O/OA/OALDERS/HTTP-Message-6.28.tar.gz
...
%prep
%setup -q -n HTTP-Message-6.28
cd %{_builddir}/HTTP-Message-6.28
...
cp %{_builddir}/HTTP-Message-6.28/LICENSE %{buildroot}/usr/share/package-licenses/perl-HTTP-Message/eeeb3a21464437014b95494ac4a3b662a0541bbb
if test -f Makefile.PL; then
